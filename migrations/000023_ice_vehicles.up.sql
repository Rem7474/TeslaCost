-- ============================================================================
-- TeslaCost Combustion Vehicles Migration (Up)
-- Database: PostgreSQL 14+
-- ============================================================================

-- 1. Vehicle powertrain (existing vehicles are electric)
ALTER TABLE vehicles ADD COLUMN IF NOT EXISTS powertrain VARCHAR(10) NOT NULL DEFAULT 'EV';
...
-- 2. Fuel fill-ups entered manually (odometer and amount are the minimum; litres refine consumption)
CREATE TABLE IF NOT EXISTS fuel_logs (
    ...
    price_per_liter NUMERIC(6, 3) CHECK (price_per_liter IS NULL OR price_per_liter >= 0),
    fuel_type VARCHAR(20) CHECK (fuel_type IS NULL OR fuel_type IN ('SP95_E10', 'SP98', 'DIESEL', 'E85', 'GPL')),
...
-- 3. Cost ledger: fuel fill-ups count as ENERGY entries
