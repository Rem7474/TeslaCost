-- ============================================================================
-- TeslaCost Cost Ledger & Vehicle Acquisition Migration (Up)
-- Database: PostgreSQL 14+
-- ============================================================================

-- 1. Vehicle acquisition (PURCHASE: price, incentives and expected resale drive depreciation;
--    LEASE: rents are recorded as recurring FINANCING expenses)
...
-- 2. Cost ledger: every cash cost of a vehicle, in EUR, as dated entries.
--    Single source for TCO totals, monthly timeline and cost rates.
--    Foreign-currency amounts without conversion rate and charges without cost are not entries
--    (they are reported as completeness gaps).
