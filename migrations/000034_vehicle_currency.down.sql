-- ============================================================================
-- TeslaCost Vehicle Currency Migration (Down)
-- ============================================================================

-- Restores cost_ledger exactly as defined in 000023_ice_vehicles (hard-coded euro comparison).
...
ALTER TABLE vehicles DROP COLUMN currency;
